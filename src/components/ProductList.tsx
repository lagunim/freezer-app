...
export default function ProductList({
  ...
  if (!loading && products.length === 0) {
    return (
      <div className="rounded-xl border border-dashed border-slate-700 bg-slate-900/40 p-6 text-center transition-colors">
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between gap-2">
        ...
        {onReload && (
          <button
            ...
            onClick={onReload}
            disabled={loading}
            className="inline-flex items-center justify-center rounded-md border border-slate-700 bg-slate-900 px-2 py-1 text-[11px] font-medium text-slate-200 transition hover:bg-slate-800 disabled:cursor-not-allowed disabled:opacity-60"
          >
      ...
      <div className="overflow-hidden rounded-xl border border-slate-700 bg-slate-900/60 shadow-sm transition-shadow">
                ...
                >
                  ...
                  <td className="px-3 py-2">
                    <div className="flex justify-end gap-1.5">
                      {isConfirmingDelete ? (
                        <>
                          <span className="py-1 text-[11px] text-amber-100">
                            ¿Borrar?
                          </span>
                          <button
                            type="button"
                            onClick={handleConfirmDelete}
                            className="inline-flex items-center justify-center rounded-md bg-red-600 px-2 py-1 text-[11px] font-medium text-white transition hover:bg-red-500"
                          >
                            Sí
                          </button>
                          <button
                            ...
                            className="inline-flex items-center justify-center rounded-md border border-slate-600 bg-slate-800 px-2 py-1 text-[11px] font-medium text-slate-100 transition hover:bg-slate-700"
                          >
                            No
                          </button>
                        </>
                        ...
                        <>
                          <button
                            ...
                            className="inline-flex items-center justify-center rounded-md border border-slate-600 bg-slate-800/80 px-2 py-1 text-[11px] font-medium text-slate-100 transition hover:border-sky-600 hover:bg-slate-800"
                          >
                            Editar
                          </button>
                          <button
                            ...
                            className="inline-flex items-center justify-center rounded-md border border-red-900/80 bg-red-950/60 px-2 py-1 text-[11px] font-medium text-red-200 transition hover:bg-red-950"
                          >
                            Borrar
                          </button>
                        </>
